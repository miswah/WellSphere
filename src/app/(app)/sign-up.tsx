...
tracking-widest"
                ...
                <TouchableOpacity
                  ...
                  <View className="flex-row items-center justify-center">
                    {isLoading
                      ? (
                        <Ionicons
                          name="refresh" size={20} color="white" />
                      ) : (
                        <Ionicons
                ...
                {/* Resend Code */}
                <TouchableOpacity className="ру-2">
...
text-center">
              ...
              <View className="mb-4">
                ...
                <View className="flex-row items-center bg-gray-50 rounded-x1
px-4 py-4 border border-gray-200">
                  ...
                  <TextInput
                    ...
                    className="flex-1 ml-3 Otext-gray-900"
                    editable={!isLoading}
                  />
                </View>
              </View>
...
px-4 py-4 border border-gray-200">
                ...
                <Text className='text-xs text-gray-500 mt-2'>Must be at least 8 characters</Text>
              </View>
